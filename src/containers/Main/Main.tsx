    ...
    <React.Fragment>
      ...
      <div className="bottom-nav">
          <NavLink to="/" exact className="link col-6" activeClassName="link--selected">
              <div>
                <div><svg className="link__svg" width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="11.1364" cy="11.1364" r="9.13636" strokeWidth="2"/><path d="M18.5606 18.5606L24.5 24.5"  stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></div>
                <span>Search</span>
              </div>
          </NavLink>
